...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1368, 28))
        font = QtGui.QFont()
        ...
        self.menuManuales = QtWidgets.QMenu(self.menubar)
        self.menuManuales.setObjectName("menuManuales")
        self.menuGrillas = QtWidgets.QMenu(self.menubar)
        self.menuGrillas.setObjectName("menuGrillas")
        ...
        self.action_Templates = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/images/images/icons/content.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Templates.setIcon(icon11)
        self.action_Templates.setObjectName("action_Templates")
        ...
        self.actionInter_Satelital = QtWidgets.QAction(MainWindow)
        self.actionInter_Satelital.setObjectName("actionInter_Satelital")
        self.actionInter_DVB = QtWidgets.QAction(MainWindow)
        self.actionInter_DVB.setObjectName("actionInter_DVB")
        self.actionGrilla_Nacional = QtWidgets.QAction(MainWindow)
        self.actionGrilla_Nacional.setObjectName("actionGrilla_Nacional")
        self.actionGrilla_HISPASAT = QtWidgets.QAction(MainWindow)
        self.actionGrilla_HISPASAT.setObjectName("actionGrilla_HISPASAT")
        self.actionConfiguraciones = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/images/images/icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfiguraciones.setIcon(icon14)
        ...
        self.menuAyuda.addAction(self.action_Templates)
        self.menuAyuda.addAction(self.actionProductos)
        self.menuAyuda.addAction(self.actionConfiguraciones)
        self.menuAyuda_2.addAction(self.actionManual_de_usuario)
        self.menuAyuda_2.addAction(self.actionAcerca_de)
        self.menuGrillas.addAction(self.actionInter_Satelital)
        self.menuGrillas.addAction(self.actionInter_DVB)
        self.menuGrillas.addAction(self.actionGrilla_Nacional)
        self.menuGrillas.addAction(self.actionGrilla_HISPASAT)
        self.menubar.addAction(self.menuInicio.menuAction())
        self.menubar.addAction(self.menuSoportes.menuAction())
        self.menubar.addAction(self.menuAyuda.menuAction())
        self.menubar.addAction(self.menuGrillas.menuAction())
        self.menubar.addAction(self.menuManuales.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuAyuda.setTitle(_translate("MainWindow", "Herramientas"))
        self.menuAyuda_2.setTitle(_translate("MainWindow", "Ayuda"))
        self.menuManuales.setTitle(_translate("MainWindow", "Manuales"))
        self.menuGrillas.setTitle(_translate("MainWindow", "Programación"))
        ...
        self.actionTelevisi_n_Satalital_DTH.setText(_translate("MainWindow", "Televisión Satelital DTH"))
        ...
        self.action_Templates.setText(_translate("MainWindow", "Plantillas"))
        self.actionProductos.setText(_translate("MainWindow", "Productos"))
        self.actionPrincipal.setText(_translate("MainWindow", "Principal"))
        self.actionInter_Satelital.setText(_translate("MainWindow", "Grilla Inter Satelital"))
        self.actionInter_DVB.setText(_translate("MainWindow", "GrillaInter DVB"))
        self.actionGrilla_Nacional.setText(_translate("MainWindow", "Grilla Nacional "))
        self.actionGrilla_HISPASAT.setText(_translate("MainWindow", "Grilla HISPASAT"))

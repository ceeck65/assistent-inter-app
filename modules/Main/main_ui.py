...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/icons/ethernet.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInternet_HFC.setIcon(icon1)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.actionInternet_HFC.setFont(font)
        self.actionInternet_HFC.setObjectName("actionInternet_HFC")
        self.actionTelevsi_n_por_cable = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/images/icons/tv-antenna.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTelevsi_n_por_cable.setIcon(icon2)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.actionTelevsi_n_por_cable.setFont(font)
        self.actionTelevsi_n_por_cable.setObjectName("actionTelevsi_n_por_cable")
        self.actionTelevisi_n_Satalital_DTH = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/images/icons/satelital.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTelevisi_n_Satalital_DTH.setIcon(icon3)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/images/icons/wi-fi-router.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFibra_Hogar.setIcon(icon4)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/images/icons/circled-envelope.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCorreos_electr_nicos.setIcon(icon5)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/images/icons/close-window.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.exitAction.setIcon(icon6)
        self.exitAction.setObjectName("exitAction")
        self.menuInicio.addAction(self.exitAction)
        self.menuSoportes.addAction(self.actionInternet_HFC)
        self.menuSoportes.addAction(self.actionTelevsi_n_por_cable)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionTelevsi_n_por_cable.setText(_translate("MainWindow", "Televsión por cable"))
